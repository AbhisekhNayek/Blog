...
const Comment = ({ props }) => {
    ...
    return (
        <div>
            <h4 className='flex items-center gap-2 text-2xl font-bold text-green-500'>
                <FaComments />
                Comment
            </h4>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)}  >
                        <div className='mb-3'>
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-green-500">Comment</FormLabel>
                                        <FormControl>
                        ...
                        <Button type="submit" className="bg-black text-green-500 hover:bg-gray-800 hover:text-green-400">
                            Submit
                        </Button>
                    </form>
                </Form>
                :
                <Button asChild className="bg-black text-green-500 hover:bg-gray-800 hover:text-green-400">
